  ...
  jQuery(document).ready(function () {
    ...
    if (
      (win.on("scroll", function () {
        ...
        scroll < 200 ? header.removeClass("stick") : header.addClass("stick");
      }),
      $(".cart-wrap").length)
    ) {
      var $body = $("body"),
    ...
    $(document)
      ...
      ($.fn.sectionJs = function () {
        var $this = this;
        $this.data("section") == "BrandSlider"
          ? $this.find(".brand_slider_active").BrandSlider()
          : $this.data("section") == "Simple_Banner"
          ? $this.find(".banner-slider-active").Simple_Banner()
          : $this.data("section") == "Bestx_Collections"
          ? $this.find(".bestcol-slider-active").Bestx_Collections()
          : $this.data("section") == "Collection_Banner"
          ? $this.find(".collection-slider-active").Collection_Banner()
          : $this.data("section") == "Feature_Collection"
          ? $this.find(".feature-product-slider-active").Feature_Collection()
          : $this.data("section") == "Tab_With_Products"
          ? $this.find(".product-slider-active").Tab_With_Products()
          : $this.data("section") == "Latest_Blog"
          ? $this.find(".blog-slider-active").Latest_Blog()
          : $this.data("section") == "About_team"
          ? $this.find(".banner-slider-active-team").About_team()
          : $this.data("section") == "Related_Products" ||
            $this.data("section") == "Related_Products"
          ? $this
              .find(".related-feature-product-slider-active")
              .Related_Products()
          : $this.data("section") == "Custom_Collection"
          ? $this
              .find(".custom-feature-product-slider-active")
              .Custom_Collection()
          : $this.data("section") == "heroOwlSlider" && $this.heroOwlSlider();
      }),
      ($.fn.BrandSlider = function () {
        var $BrandSliderVAR = this;
        $BrandSliderVAR.slick({ infinite: !0 });
      }),
      ($.fn.Simple_Banner = function () {
        var $Simple_BannerVAR = this;
        $Simple_BannerVAR.slick({ infinite: !0 });
      }),
      ($.fn.Feature_Collection = function () {
        var $Feature_CollectionVAR = this;
        $Feature_CollectionVAR.slick({ infinite: !0 });
      }),
      ($.fn.Tab_With_Products = function () {
        var $Tab_With_ProductsVAR = this;
        $Tab_With_ProductsVAR.slick({ infinite: !0 });
      }),
      ($.fn.Latest_Blog = function () {
        var $Latest_BlogVAR = this;
        $Latest_BlogVAR.slick({ infinite: !0 });
      }),
      ($.fn.Bestx_Collections = function () {
        var $Best_CollectionsVAR = this;
        $Best_CollectionsVAR.slick({ infinite: !0 });
      }),
      ($.fn.About_team = function () {
        var $About_teamVAR = this;
        $About_teamVAR.slick({ infinite: !0 });
      }),
      ($.fn.Related_Products = function () {
        var $Related_ProductsVAR = this;
        $Related_ProductsVAR.slick({ infinite: !0 });
      }),
      ($.fn.Custom_Collection = function () {
        var $Custom_CollectionVAR = this;
        $Custom_CollectionVAR.slick({ infinite: !0 });
      }),
      ($.fn.Collection_Banner = function () {
        var $Collection_BannerVAR = this;
        $Collection_BannerVAR.slick({ infinite: !0 });
      }),
      ($.fn.heroOwlSlider = function () {
        var $carousel = $("[data-owl-carousel]"),
          $heroSlider = $(".slider-active"),
          $slider_boxed_active = $(".slider-active-boxed"),
          $slider_special_active = $(".slider-active-special"),
          $about_testimonial = $(".testimonial-active-test");
        $carousel.length &&
    ...
    function sidebarSearch() {
      ...
      searchTrigger.on("click", function (e) {
        e.preventDefault(), container.addClass("inside");
      }),
    ...
    $quickview_slider.length > 0 &&
      $quickview_slider.owlCarousel({
        ...
        dots: !1,
        responsive: {
          0: { items: 3, autoplay: !0, smartSpeed: 300 },
          576: { items: 3 },
          768: { items: 3 },
          1e3: { items: 3 },
        },
    ...
    CartPlusMinus.prepend('<div class="dec qtybutton">-</div>'),
      ...
      //                 .slice(0, 4)
      //                 .slideDown(),
      //               $(".toggle-item-active:hidden").length == 0 &&
      //                 $(this).parent(".toggle-btn").fadeOut("slow");
      //           });
      //     }
      //     itemToggler();
      //     var $scroll_zoom_var = $(".scroll-zoom");
      //     $scroll_zoom_var.length > 0 &&
      ...
      //           (e.preventDefault(),
      //           $this.siblings("ul:visible").length
      ...
      //       sidebarMainmenu();
      //     }
      //     var $slider2 = $(".product-slider-active-2");
      //     $slider2.length > 0 &&
      //       $slider2.owlCarousel({
      //         loop: !0,
      //         nav: !1,
      ...
      //         e.preventDefault(), $(".category-item-parent.hidden").toggle(500);
      //         var htmlAfter = "Hide More Type",
      //           htmlBefore = "Show More Type";
      //         $(this).html($(this).text() == htmlAfter ? htmlBefore : htmlAfter),
      //           $(this).toggleClass("minus");
      //       });
      //     var $mag_video_pop = $(".video-popup");
      //     $mag_video_pop.length > 0 &&
      ...
      //         e.preventDefault(), $(".checkout-login-info3").slideToggle(1e3);
      //       }),
      //       $(".checkout-toggle2").on("click", function () {
      //         $(".open-toggle2").slideToggle(1e3);
      //       }),
      //       $(".checkout-toggle").on("click", function () {
      //         $(".open-toggle").slideToggle(1e3);
      //       });
      //     var checked = $(".sin-payment input:checked");
      //     checked && $(checked).siblings(".payment-box").slideDown(900),
      ...
      //           .parent()
      //           .find(".variant_img a img")
      //           .attr("src");
      //         return (
      //           jQuery(this)
      //             .parents(".pgrid_9")
      //             .find(".theme-product-image .pgrid_9_img a img")
      ...
      //         $(".color-categories li .variant_img a.active").removeClass(
      //           "active"
      //         ),
      ...
      $(".product-color li label").click(function () {
        ...
        return (
          jQuery(this)
            .parents(".product-wrapper-class")
            .find(".popup_cart_image")
            .attr({ src: variantImage }),
          !1
        );
      });
    function proStikcyAddToCart() {
      ...
      if ($stikcyParent.length) {
        $stickyProVarItem
          .off("click.activeVar")
          .on("click.activeVar", function (e) {
            var $this = $(this),
              $text = $this.text(),
              $StickyVarval2 = $this.data("value"),
              $varnewImg = $this.data("img"),
              $newqty = $this.data("quantity");
            $stickyProVarItem.removeClass("active"),
              $this.addClass("active"),
              $stikcyParent
                .find(".sticky__pro_add_cart input[type=hidden]")
                .val($StickyVarval2),
              $proVarintActive.attr("data-value", $StickyVarval2).text($text);
            var $variantSwtval = $(
              '#AddToCartForm [data-value-sticky="' + $StickyVarval2 + '"]'
            );
            return (
        ...
        var $optionSelected = $("#product-selectors option:selected"),
          ...
          $prostickyActive = $stikcyParent.find(
            '.pro_variant_swatch[data-value="' + $StickyVarval + '"]'
          ),
        ...
        $(".sticky_pro_img img").attr({ src: $datastr }),
          $(".swatch .swatch-element").each(function (e) {
            ...
            $('.swatch input.text[data-value="' + $varid + '"]').appendTo(
              $(this)
            );
          }),
          $(".selector-wrapper").change(function () {
            ...
            if (
              ...
              $("#product-selectors")
                ...
                .trigger("change"),
              $stickyProVarItem.hasClass("active"))
            ) {
              var $StikcyVarhtml = $(
                ".pro_sticky_atc .pro_variant_swatch.active"
              ).html();
              $(".pro_sticky_atc .sticky__pro_add_cart input[type=hidden]").val(
                $proSelectors
              ),
      ...
      $(".quantity_inner")
        ...
        .click(function (e) {
          var $qty_field = $(this).parent().find("input"),
            $qtCount =
              parseInt($qty_field.val(), 10) +
              parseInt(e.currentTarget.className === "inc_btn" ? 1 : -1, 10);
    ...
    function lookbookkjs() {
      ...
      clothTag.each(function () {
        ...
        $("body").on("click", function (e) {
          $(e.target).is(".cloth-tag__content.active") ||
...
//# sourceMappingURL=/Assets/shop/t/9/assets/theme.js.map?v=58729172318499673551698938089
