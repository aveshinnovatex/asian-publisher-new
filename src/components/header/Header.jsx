    ...
    <div className="header-search">
      <div className="cart-wrap">
        ...
        <div className="shopping-cart-content">
          <div className="cart-empty-title" style={{ display: "block" }}>
            <form
              action="#"
              method="get"
              role="search"
      ...
      <div className="shopping-cart-content">
        ...
        >
          <div className="shopping-cart-total">
            <h4>
              Total:{"{"}" "{"}"}
              <span className="shop-total shopping-cart__total">Rs. 0.00</span>
            </h4>
          </div>
          <div className="shopping-cart-btn btn-hover text-center">
            <a className="default-btn" href="account/loginfc3a.html">
              Checkout
            </a>
