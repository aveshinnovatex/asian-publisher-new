          ...
          <div className="container">
            <div className="col-lg-7" style={{ float: "left" }}>
              ...
              <p style={{ textAlign: "justify", width: "80%" }}>
                Asian Publishers, Muzaffarnagar is one of the largest and
                leading academic publishers in Uttar Pradesh.Low-cost and
                high-quality affordable texts of Asian Publishers, Muzaffarnagar
                have been the pioneer in learning states of UP and UK. We have,
                so far, release more than 250 titles encompassing various
                branches: Civil Engineering, Electrical Engineering, Mechanical
                Engineering, Electronics Engineering, Computer Science
                Engineering and Information Technology and so on.
              </p>
            </div>
            <div
              className="col-lg-5"
            ...
            <div className="col-lg-7" style={{ float: "left" }}>
              ...
              <div className="col-lg-10" style={{ float: "left" }}>
                ...
                <p style={{ textAlign: "justify" }}>
                  ...
                  just the theoretical but the practical aspects of the
                  respective subject as well.
                  <br />
                  <br />
                  You should choose Asian Publishers because we promise to
                  continuously upgrade our standards to provide the best
                  learning material and set the highest benchmarks for ourselves
          ...
          <div className="container-fluid">
            <div className="col-lg-7" style={{ float: "left" }}>
              ...
              <p style={{ textAlign: "justify", width: "90%" }}>
                ...
                impact the lives of millions of students with only a single
                title under his name.
                <br />
                <br />
                With consistent efforts to fully achieve his goal of spreading
                education and knowledge through simplistic learning methods,
                Asian publishers now have over 250 titles under its name. Sh.
                Satya Prakash Mittal has given Asian Publishers its true values
                of making our nation great through work on the grassroots level
                via education and learning.
                <br />
                <br />
                Through his efforts, Asian Publishers is one of the biggest
                names in the higher education industry in the Indian states of
